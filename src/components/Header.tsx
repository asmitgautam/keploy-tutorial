    ...
    <header className="sticky top-1 z-10 border-b border-black/10 dark:border-white/10 bg-[#F1F3F1]/80 dark:bg-[#0A0D0C]/80 backdrop-blur">
      <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <a href="https://github.com/asmitgautam/keploy-tutorial" target="_blank" rel="noopener noreferrer" className="text-sm text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white transition-colors">View on GitHub</a>
          {mounted && (
